...
class ProxyCustomServerTest extends Scope
{
    ...
    public function testCreateAPIRule(): void
    {
        ...
        $proxyClient->setEndpoint('http://bapxdb.test');
        $proxyClient->addHeader('x-bapxdb-hostname', $domain);
    ...
    {
        // Create function bapxdb-network domain
        ...
        // Create site bapxdb-network domain
