...
class SitesCustomServerTest extends Scope
{
    ...
    public function testVariablesE2E(): void
    {
        ...
        $this->assertStringContainsString("Env variable is bapXdb", $response['body']);
    ...
    public function testSiteStatic(): void
    {
        ...
        $this->assertArrayHasKey('x-bapxdb-log-id', $response['headers']);
        $this->assertNotEmpty($response['headers']['x-bapxdb-log-id']);
    ...
    public function testSiteDomainReclaiming(): void
    {
        ...
        $this->assertEquals(200, $response['headers']['status-code']);
        $this->assertStringNotContainsString("This domain is not connected to any bapXdb resource yet", $response['body']);
    ...
    public function testSitePreviewBranding(): void
    {
        ...
        $response = $proxyClient->call(Client::METHOD_GET, '/');
        $this->assertEquals(200, $response['headers']['status-code']);
        $this->assertStringContainsString("Hello bapXdb", $response['body']);
    ...
    public function testPreviewDomain(): void
    {
        ...
        $response = $proxyClient->call(Client::METHOD_GET, '/_bapxdb/authorize', params: [
            'jwt' => $jwt['body']['jwt'],
            'path' => '/contact'
        ...
        $email = \uniqid() . 'newuser@bapxdb.io';
