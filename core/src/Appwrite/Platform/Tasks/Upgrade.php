...
class Upgrade extends Install
{
    ...
    public function action(string $httpPort, string $httpsPort, string $organization, string $image, string $interactive, bool $noStart): void
    {
        ...
        if (empty($data)) {
            Console::error('bapXdb installation not found.');
            Console::log('The command was not run in the parent folder of your bapxdb installation.');
            Console::log('Please navigate to the parent directory of the bapXdb installation and try again.');
