...
class DatabasesCustomServerTest extends Scope
{
    ...
    public function testAttributeUpdateString(array $data)
    {
        ...
        $this->assertEquals(bapXdbException::GENERAL_ARGUMENT_INVALID, $update['body']['type']);
        ...
        $this->assertEquals(400, $update['headers']['status-code']);
        $this->assertEquals(bapXdbException::ATTRIBUTE_DEFAULT_UNSUPPORTED, $update['body']['type']);
    }
    ...
    public function testAttributeUpdateEmail(array $data)
    {
        ...
        $this->assertFalse($new['body']['required']);
        $this->assertEquals('torsten@bapxdb.io', $new['body']['default']);
        ...
        $this->assertNotNull($attribute);
        $this->assertFalse($attribute['required']);
        $this->assertEquals('torsten@bapxdb.io', $attribute['default']);
        ...
        $this->assertFalse($new['body']['required']);
        $this->assertEquals('eldad@bapxdb.io', $new['body']['default']);
    ...
    public function testAttributeUpdateUrl(array $data)
    {
        ...
        $this->assertFalse($new['body']['required']);
        $this->assertEquals('http://bapxdb.io', $new['body']['default']);
        ...
        $this->assertNotNull($attribute);
        $this->assertFalse($attribute['required']);
        $this->assertEquals('http://bapxdb.io', $attribute['default']);
        ...
        $this->assertFalse($new['body']['required']);
        $this->assertEquals('https://bapxdb.io', $new['body']['default']);
    ...
    public function testAttributeUpdateInteger(array $data)
    {
        ...
        $this->assertEquals(400, $update['headers']['status-code']);
        $this->assertEquals(bapXdbException::ATTRIBUTE_VALUE_INVALID, $update['body']['type']);
    ...
    public function testAttributeUpdateStringResize(array $data)
    {
        ...
        $this->assertEquals(bapXdbException::ATTRIBUTE_INVALID_RESIZE, $attribute['body']['type']);
        ...
        $this->assertEquals(bapXdbException::DOCUMENT_INVALID_STRUCTURE, $newDoc['body']['type']);
    }
    ...
    public function testAttributeUpdateNotFound(array $data)
    {
        ...
        foreach ($attributes as $key => $payload) {
            ...
            $this->assertEquals(bapXdbException::DATABASE_NOT_FOUND, $update['body']['type']);
            ...
            $this->assertEquals(404, $update['headers']['status-code']);
            $this->assertEquals(bapXdbException::COLLECTION_NOT_FOUND, $update['body']['type']);
            ...
            $this->assertEquals(404, $update['headers']['status-code']);
            $this->assertEquals(bapXdbException::ATTRIBUTE_NOT_FOUND, $update['body']['type']);
        }
    }
