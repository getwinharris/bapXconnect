...
namespace bapXdb\Platform\Modules\Sites\Http\Deployments\Template;
    ...
    public function __construct()
    {
        $this
            ...
            ->label('sdk', new Method(
                ...
                Use this endpoint with combination of [listTemplates](https://bapxdb.io/docs/products/sites/templates) to find the template details.
                EOT,
