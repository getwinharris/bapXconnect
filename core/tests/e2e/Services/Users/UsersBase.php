...
trait UsersBase
{
    public function testCreateUser(): array
    {
        ...
        $res = $this->client->call(Client::METHOD_POST, '/users/md5', array_merge([
            ...
            'userId' => 'md5',
            'email' => 'md5@bapxdb.io',
            'password' => '144fa7eaa4904e8ee120651997f70dcc', // bapxdb
            'name' => 'MD5 User',
        ]);
        ...
        $res = $this->client->call(Client::METHOD_POST, '/users/bcrypt', array_merge([
            ...
            'userId' => 'bcrypt',
            'email' => 'bcrypt@bapxdb.io',
            'password' => '$2a$15$xX/myGbFU.ZSKHSi6EHdBOySTdYm8QxBLXmOPHrYMwV0mHRBBSBOq', // bapxdb (15 rounds)
            'name' => 'Bcrypt User',
        ]);
        ...
        $res = $this->client->call(Client::METHOD_POST, '/users/argon2', array_merge([
            ...
            'userId' => 'argon2',
            'email' => 'argon2@bapxdb.io',
            'password' => '$argon2i$v=19$m=20,t=3,p=2$YXBwd3JpdGU$A/54i238ed09ZR4NwlACU5XnkjNBZU9QeOEuhjLiexI', // bapxdb (salt bapxdb, parallel 2, memory 20, iterations 3, length 32)
            'name' => 'Argon2 User',
        ]);
        ...
        $res = $this->client->call(Client::METHOD_POST, '/users/sha', array_merge([
            ...
            'userId' => 'sha512',
            'email' => 'sha512@bapxdb.io',
            'password' => '4243da0a694e8a2f727c8060fe0507c8fa01ca68146c76d2c190805b638c20c6bf6ba04e21f11ae138785d0bff63c416e6f87badbffad37f6dee50094cc38c70', // bapxdb (sha512)
            'name' => 'SHA512 User',
        ...
        $res = $this->client->call(Client::METHOD_POST, '/users/scrypt', array_merge([
            ...
            'userId' => 'scrypt',
            'email' => 'scrypt@bapxdb.io',
            'password' => '3fdef49701bc4cfaacd551fe017283513284b4731e6945c263246ef948d3cf63b5d269c31fd697246085111a428245e24a4ddc6b64c687bc60a8910dbafc1d5b', // bapxdb (salt bapxdb, cpu 16384, memory 13, parallel 2, length 64)
            'name' => 'Scrypt User',
            'passwordSalt' => 'bapxdb',
            'passwordCpu' => 16384,
            'passwordMemory' => 13,
        ...
        $this->assertEquals($res['body']['hashOptions']['salt'], 'bapxdb');
        ...
        $res = $this->client->call(Client::METHOD_POST, '/users/scrypt-modified', array_merge([
            ...
            'email' => 'scrypt-modified@bapxdb.io',
            'password' => 'UlM7JiXRcQhzAGlaonpSqNSLIz475WMddOgLjej5De9vxTy48K6WtqlEzrRFeK4t0COfMhWCb8wuMHgxOFCHFQ==', // bapxdb
    ...
    public function testCreateUserSessionHashed(array $data): void
    {
        ...
        foreach ($userIds as $userId) {
            ...
            $this->assertEquals($userId . '@bapxdb.io', $response['body']['email']);
    ...
    public function testCreateSession(array $data): void
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, '/account', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $this->getProject()['$id'],
            'x-bapxdb-session' => $session['secret']
        ]);
