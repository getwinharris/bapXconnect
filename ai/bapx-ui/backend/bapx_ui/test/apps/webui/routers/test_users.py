...
def _assert_user(data, id, **kwargs):
    ...
    comparison_data = {
        "name": f"user {id}",
        "email": f"user{id}@openbapx_ui.com",
    ...
    def test_users(self):
        ...
        with mock_bapx_ui_user(id="1"):
            response = self.fast_api_client.post(
                ...
                json={
                    "name": "user 2 updated",
                    "email": "user2-updated@openbapx_ui.com",
