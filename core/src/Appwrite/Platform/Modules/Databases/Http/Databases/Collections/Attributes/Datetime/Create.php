...
namespace bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Attributes\Datetime;
...
class Create extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('collectionId', '', new UID(), 'Collection ID. You can create a new collection using the Database service [server integration](https://bapxdb.io/docs/server/databases#createCollection).')
