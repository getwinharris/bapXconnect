...
class RealtimeCustomClientTest extends Scope
{
    ...
    public function testConnectionPlatform()
    {
         ...
         * Test for FAILURE
         */
        $client = $this->getWebsocket(['documents'], ['origin' => 'http://bapxdb.unknown']);
        ...
        $this->assertEquals('Invalid Origin. Register your new client (bapxdb.unknown) as a new Web platform on your project console dashboard', $payload['data']['message']);
        \usleep(250000); // 250ms
    ...
    public function testChannelAccount()
    {
        ...
        $this->assertContains("users.*", $response['data']['events']);
        $this->assertNotEmpty($response['data']['payload']);
        $this->assertEquals('torsten@bapxdb.io', $response['data']['payload']['email']);
