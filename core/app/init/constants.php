...
use bapXdb\Platform\Modules\Compute\Specification;

const APP_NAME = 'bapX';
const APP_DOMAIN = 'bapx.in';
const AI_DOMAIN = 'ai.bapx.in';

// Email
const APP_EMAIL_TEAM = 'team@localhost.test'; // Default email address
const APP_EMAIL_SECURITY = ''; // Default security email address
const APP_EMAIL_LOGO_URL = 'https://cloud.bapxdb.io/images/mails/logo.png';
const APP_EMAIL_ACCENT_COLOR = '#fd366e';
const APP_EMAIL_TERMS_URL = 'https://bapxdb.io/terms';
const APP_EMAIL_PRIVACY_URL = 'https://bapxdb.io/privacy';
const APP_EMAIL_PLATFORM_NAME = 'bapXdb';
const APP_EMAIL_FOOTER_IMAGE_URL = 'https://bapxdb.io/email/footer.png';
...
const APP_SOCIAL_TWITTER = 'https://twitter.com/bapxdb';
const APP_SOCIAL_TWITTER_HANDLE = 'bapxdb';
const APP_SOCIAL_FACEBOOK = 'https://www.facebook.com/bapxdb.io';
const APP_SOCIAL_LINKEDIN = 'https://www.linkedin.com/company/bapxdb';
const APP_SOCIAL_INSTAGRAM = 'https://www.instagram.com/bapxdb.io';
const APP_SOCIAL_GITHUB = 'https://github.com/bapxdb';
const APP_SOCIAL_GITHUB_APPWRITE = 'https://github.com/bapxdb/bapxdb';
const APP_SOCIAL_DISCORD = 'https://bapxdb.io/discord';
const APP_SOCIAL_DISCORD_CHANNEL = '564160730845151244';
const APP_SOCIAL_DEV = 'https://dev.to/bapxdb';
const APP_SOCIAL_STACKSHARE = 'https://stackshare.io/bapxdb';
const APP_SOCIAL_YOUTUBE = 'https://www.youtube.com/c/bapxdb?sub_confirmation=1';
...
const APP_VCS_GITHUB_USERNAME = 'bapXdb';
const APP_VCS_GITHUB_EMAIL = 'team@bapxdb.io';
const APP_VCS_GITHUB_URL = 'https://github.com/TeambapXdb';
...
// Function headers
const FUNCTION_ALLOWLIST_HEADERS_REQUEST = ['content-type', 'agent', 'content-length', 'host', 'x-bapxdb-client-ip'];
