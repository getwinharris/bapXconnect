...
$http->on(Constant::EVENT_START, function (Server $http) use ($payloadSize, $register) {
    ...
    go(function () use ($register, $app) {
        ...
        // create bapxdb database, `dbForPlatform` is a direct access call.
        createDatabase($app, 'dbForPlatform', 'bapxdb', $collections['console'], $pools, function (Database $dbForPlatform) use ($collections, $app) {
