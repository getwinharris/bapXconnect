...
Init your bapXdb client:

```dart
Client client = Client();

client
    .setEndpoint('https://localhost/v1') // Your bapXdb Endpoint
...
final session = await account.createEmailSession(email: 'me@bapxdb.io', password: 'password');
...
All examples and API features are available at the [official bapXdb docs](https://bapxdb.io/docs)
