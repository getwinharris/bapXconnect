...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on bapx-ui.
...
7. **Default Configuration Testing**: All vulnerability reports MUST be tested and reproducible using bapX AI's out-of-the-box default configuration. Claims of vulnerabilities that only manifest with explicitly weakened security settings may be discarded, unless they are covered by the following exception:
...
8. **Threat Model Understanding Required**: Reports must demonstrate understanding of bapX AI's self-hosted, authenticated, role-based access control architecture. Comparing bapX AI to services with fundamentally different security models without acknowledging the architectural differences may result in report rejection.
...
>
> - If we suspect you used AI (but you did not disclose it to us), we will be asking tough follow-up questions to validate your understanding of the reported vulnerability and bapX AI itself.
...
> - had a clear lack of understanding of bapX AI
...
If you want to report a vulnerability and can meet the outlined requirements, [open a vulnerability report here](https://github.com/bapx-ui/bapx-ui/security/advisories/new).
...
- **Documentation issues/improvement ideas:** Open an issue on our [Documentation Repository](https://github.com/bapx-ui/docs)
- **Feature requests:** Create a discussion in [GitHub Discussions - Ideas](https://github.com/bapx-ui/bapx-ui/discussions/) to discuss with the community if this feature request is wanted by multiple people
...
- **General issues:** Use our [Issue Tracker](https://github.com/bapx-ui/bapx-ui/issues)
...
For any other immediate concerns, please create an issue in our [issue tracker](https://github.com/bapx-ui/bapx-ui/issues) or contact our team on [Discord](https://discord.gg/5rJgQTnV4s).
