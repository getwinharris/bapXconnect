...
namespace bapXdb\Platform\Modules\Functions\Http\Executions;
...
use bapXdb\Functions\Validator\Headers;
...
class Create extends Base
{
    ...
    public function action(
        ...
        $headers['x-bapxdb-key'] = API_KEY_DYNAMIC . '_' . $apiKey;
        $headers['x-bapxdb-trigger'] = 'http';
        $headers['x-bapxdb-user-id'] = $user->getId() ?? '';
        $headers['x-bapxdb-user-jwt'] = $jwt ?? '';
        ...
        $executionResponse['headers']['x-bapxdb-execution-id'] = $execution->getId();
