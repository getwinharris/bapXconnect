...
from bapx_ui.models.auths import Auths
from bapx_ui.models.oauth_sessions import OAuthSessions
from bapx_ui.models.users import Users


from bapx_ui.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from bapx_ui.utils.misc import parse_duration
from bapx_ui.utils.auth import get_password_hash, create_token
...
from bapx_ui.env import GLOBAL_LOG_LEVEL
...
async def get_oauth_client_info_with_dynamic_client_registration(
    ...
    try:
        ...
        redirect_base_url = (
            str(request.app.state.config.BAPX_UI_URL or request.base_url)
        ).rstrip("/")
