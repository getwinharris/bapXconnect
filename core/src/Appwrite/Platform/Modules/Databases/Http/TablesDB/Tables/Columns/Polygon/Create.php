...
namespace bapXdb\Platform\Modules\Databases\Http\TablesDB\Tables\Columns\Polygon;

use bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Attributes\Polygon\Create as PolygonCreate;
...
class Create extends PolygonCreate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('tableId', '', new UID(), 'Table ID. You can create a new table using the TablesDB service [server integration](https://bapxdb.io/docs/references/cloud/server-dart/tablesDB#createTable).')
