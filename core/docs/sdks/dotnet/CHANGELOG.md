...
* fix: remove content-type from GET requests by @loks0n in https://github.com/bapxdb/sdk-for-dotnet/pull/59
* update: min and max are not optional in methods like `UpdateIntegerAttribute` etc.
* chore: regenerate sdk by @ChiragAgg5k in https://github.com/bapxdb/sdk-for-dotnet/pull/60
* chore: fix build error by @ChiragAgg5k in https://github.com/bapxdb/sdk-for-dotnet/pull/61

## 0.11.0

* Add new push message parameters by @abnegate in https://github.com/bapxdb/sdk-for-dotnet/pull/56

## 0.10.0

* fix: chunk upload by @byawitz in https://github.com/bapxdb/sdk-for-dotnet/pull/52
