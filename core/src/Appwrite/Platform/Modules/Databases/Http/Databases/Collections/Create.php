...
namespace bapXdb\Platform\Modules\Databases\Http\Databases\Collections;
...
use bapXdb\Utopia\Database\Validator\Attributes as AttributesValidator;
use bapXdb\Utopia\Database\Validator\CustomId;
use bapXdb\Utopia\Database\Validator\Indexes as IndexesValidator;
...
class Create extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('permissions', null, new Nullable(new Permissions(APP_LIMIT_ARRAY_PARAMS_SIZE)), 'An array of permissions strings. By default, no user is granted with any permissions. [Learn more about permissions](https://bapxdb.io/docs/permissions).', true)
            ->param('documentSecurity', false, new Boolean(true), 'Enables configuring permissions for individual documents. A user needs one of document or collection level permissions to access a document. [Learn more about permissions](https://bapxdb.io/docs/permissions).', true)
