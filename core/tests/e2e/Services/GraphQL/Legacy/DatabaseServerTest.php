...
class DatabaseServerTest extends Scope
{
    ...
    public function testUpdateEmailAttribute($data): array
    {
        ...
        $this->assertEquals('torsten@bapxdb.io', $attribute['body']['data']['databasesUpdateEmailAttribute']['default']);
        $this->assertEquals(200, $attribute['headers']['status-code']);
    ...
    public function testUpdateURLAttribute($data): void
    {
        ...
        $this->assertEquals('https://cloud.bapxdb.io', $attribute['body']['data']['databasesUpdateUrlAttribute']['default']);
        $this->assertEquals(200, $attribute['headers']['status-code']);
    }
