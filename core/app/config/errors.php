...
use bapXdb\Messaging\Status as MessageStatus;
...
return [
    ...
    Exception::GENERAL_UNKNOWN_ORIGIN => [
        ...
        'description' => 'The request originated from an unknown origin. If you trust this domain, please list it as a trusted platform in the bapXdb console.',
        'code' => 403,
    ],
    Exception::GENERAL_API_DISABLED => [
        'name' => Exception::GENERAL_API_DISABLED,
        'description' => 'The requested API is disabled. You can enable the API from the bapXdb console.',
        'code' => 403,
    ],
    Exception::GENERAL_SERVICE_DISABLED => [
        'name' => Exception::GENERAL_SERVICE_DISABLED,
        'description' => 'The requested service is disabled. You can enable the service from the bapXdb console.',
        'code' => 403,
    ],
    ...
    Exception::GENERAL_SMTP_DISABLED => [
        ...
        'description' => 'SMTP is disabled on your bapXdb instance. You can <a href="/docs/email-delivery">learn more about setting up SMTP</a> in our docs.',
        'code' => 503,
    ],
    Exception::GENERAL_PHONE_DISABLED => [
        'name' => Exception::GENERAL_PHONE_DISABLED,
        'description' => 'Phone provider is not configured. Please check the _APP_SMS_PROVIDER environment variable of your bapXdb server.',
        'code' => 503,
    ],
    ...
    Exception::GENERAL_USAGE_DISABLED => [
        ...
        'description' => 'Usage stats is not configured. Please check the value of the _APP_USAGE_STATS environment variable of your bapXdb server.',
        'code' => 501,
    ],
    Exception::GENERAL_NOT_IMPLEMENTED => [
        'name' => Exception::GENERAL_NOT_IMPLEMENTED,
        'description' => 'This method was not fully implemented yet. If you believe this is a mistake, please upgrade your bapXdb server version.',
        'code' => 405,
    ],
    ...
    Exception::USER_COUNT_EXCEEDED => [
        ...
        'description' => 'The current project has exceeded the maximum number of users. Please check your user limit in the bapXdb console.',
        'code' => 400,
    ],
    ...
    Exception::USER_JWT_INVALID => [
        ...
        'description' => 'The JWT token is invalid. Please check the value of the X-bapXdb-JWT header to ensure the correct token is being used.',
        'code' => 401,
    ],
    ...
    Exception::USER_BLOCKED => [
        ...
        'description' => 'The current user has been blocked. You can unblock the user by making a request to the User API\'s "Update User Status" endpoint or in the bapXdb Console\'s Auth section.',
        'code' => 401,
    ],
    ...
    Exception::USER_AUTH_METHOD_UNSUPPORTED => [
        ...
        'description' => 'The requested authentication method is either disabled or unsupported. Please check the supported authentication methods in the bapXdb console.',
        'code' => 501,
        'publish' => false,
    ],
    ...
    Exception::USER_API_KEY_AND_SESSION_SET => [
        ...
        'description' => 'API key and session used in the same request. Use either `setSession` or `setKey`. Learn about which authentication method to use in the SSR docs: https://bapxdb.io/docs/products/auth/server-side-rendering',
        'code' => 403,
    ],
    ...
    Exception::STORAGE_INVALID_APPWRITE_ID => [
        ...
        'description' => 'The value for x-bapxdb-id header is invalid. Please check the value of the x-bapxdb-id header is a valid id and not unique().',
        'code' => 400,
    ],
    ...
    Exception::FUNCTION_ENTRYPOINT_MISSING => [
        ...
        'description' => 'Entrypoint for your bapXdb Function is missing. Please specify it when making deployment or update the entrypoint under your function\'s "Settings" > "Configuration" > "Entrypoint".',
        'code' => 404,
    ],
    ...
    Exception::PROJECT_NOT_FOUND => [
        ...
        'description' => 'Project with the requested ID could not be found. Please check the value of the X-bapXdb-Project header to ensure the correct project ID is being used.',
        'code' => 404,
    ],
    ...
    Exception::PROJECT_PROVIDER_DISABLED => [
        ...
        'description' => 'The chosen OAuth provider is disabled. You can enable the OAuth provider using the bapXdb console.',
        'code' => 412,
    ],
    ...
    Exception::PROJECT_KEY_EXPIRED => [
        ...
        'description' => 'The project key has expired. Please generate a new key using the bapXdb console.',
        'code' => 401,
    ],
    ...
    Exception::ROUTER_DOMAIN_NOT_CONFIGURED => [
        ...
        'description' => '_APP_DOMAIN, _APP_DOMAIN_TARGET, and _APP_DOMAIN_FUNCTIONS environment variables have not been configured. Please configure the domain environment variables before accessing the bapXdb Console via any IP address or hostname other than localhost. This value could be an IP like 203.0.113.0 or a hostname like example.com.',
        'code' => 500,
    ],
    ...
    Exception::MIGRATION_IN_PROGRESS => [
        ...
        'description' => 'Migration is already in progress. You can check the status of the migration in your bapXdb Console\'s "Settings" > "Migrations".',
        'code' => 409,
    ],
