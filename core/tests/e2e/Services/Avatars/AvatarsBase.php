...
trait AvatarsBase
{
    ...
    public function testGetImage(): array
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, '/avatars/image', [
            ...
            'url' => 'https://bapxdb.io/images/open-graph/website.png',
        ]);
        ...
        $response = $this->client->call(Client::METHOD_GET, '/avatars/image', [
            ...
            'url' => 'https://bapxdb.io/images/unknown.png',
            'width' => 300,
            'height' => 300,
            'quality' => 30,
        ]);
        ...
        $response = $this->client->call(Client::METHOD_GET, '/avatars/image', [
            ...
            'url' => 'invalid://bapxdb.io/images/apple.png'
        ]);
    ...
    public function testGetScreenshot(): array
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, '/avatars/screenshots', [
            ...
            'url' => 'https://bapxdb.io?x=' . time() . rand(1000, 9999),
            'width' => 800,
            'height' => 600,
        ]);
        ...
        $response = $this->client->call(Client::METHOD_GET, '/avatars/screenshots', [
            ...
            'height' => 600,
            'headers' => [
                'User-Agent' => 'Mozilla/5.0 (compatible; bapXdbBot/1.0)',
