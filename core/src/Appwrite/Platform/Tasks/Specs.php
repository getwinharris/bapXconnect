...
use bapXdb\SDK\Specification\Format\OpenAPI3;
use bapXdb\SDK\Specification\Format\Swagger2;
use bapXdb\SDK\Specification\Specification;
use bapXdb\Utopia\Request as bapXdbRequest;
use bapXdb\Utopia\Response as bapXdbResponse;
use Exception;
...
class Specs extends Action
{
    ...
    {
        $this
            ->desc('Generate bapXdb API specifications')
    ...
    {
        return new bapXdbRequest(new SwooleRequest());
    }

    public function getResponse(): UtopiaResponse
    {
        return new bapXdbResponse(new SwooleResponse());
    }
    ...
    protected function getKeys(): array
    {
        return [
            APP_SDK_PLATFORM_CLIENT => [
                ...
                'Locale' => [
                    'type' => 'apiKey',
                    'name' => 'X-bapXdb-Locale',
                    'description' => '',
                    'in' => 'header',
                ],
                'Session' => [
                    'type' => 'apiKey',
                    'name' => 'X-bapXdb-Session',
                    'description' => 'The user session to authenticate with',
                    'in' => 'header',
                ],
                'DevKey' => [
                    'type' => 'apiKey',
                    'name' => 'X-bapXdb-Dev-Key',
        ...
        foreach ($platforms as $platform) {
            ...
            foreach (['swagger2', 'open-api3'] as $format) {
                ...
                $formatInstance
                    ...
                    ->setParam('endpoint', 'https://cloud.bapxdb.io/v1')
                    ->setParam('endpoint.docs', 'https://<REGION>.cloud.bapxdb.io/v1')
                    ...
                    ->setParam('license.url', 'https://raw.githubusercontent.com/bapxdb/bapxdb/master/LICENSE')
