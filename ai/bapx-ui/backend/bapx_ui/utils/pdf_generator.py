...
from bapx_ui.env import STATIC_DIR, FONTS_DIR
from bapx_ui.models.chats import ChatTitleMessagesForm
...
class PDFGenerator:
    ...
    def generate_chat_pdf(self) -> bytes:
        ...
        try:
            ...
            # This path only works if `bapx-ui serve` is run from the root of this project.
            if not FONTS_DIR.exists():
