...
namespace bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Attributes;
...
use bapXdb\Utopia\Database\Validator\Queries\Attributes;
...
class XList extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('queries', [], new Attributes(), 'Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://bapxdb.io/docs/queries). Maximum of ' . APP_LIMIT_ARRAY_PARAMS_SIZE . ' queries are allowed, each ' . APP_LIMIT_ARRAY_ELEMENT_SIZE . ' characters long. You may filter on the following attributes: ' . implode(', ', Attributes::ALLOWED_ATTRIBUTES), true)
