...
return [
    ...
    'account' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/client/account',
        'tests' => false,
        'optional' => true,
    ...
    'avatars' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/client/avatars',
        'tests' => false,
        'optional' => true,
    ...
    'databases' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/client/databases',
        'tests' => false,
        'optional' => true,
    ...
    'tablesdb' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/client/tablesdb',
        'tests' => false,
        'optional' => true,
        'icon' => '/images/services/databases.png',
        'platforms' => ['client', 'server', 'console'],
    ...
    'locale' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/client/locale',
        'tests' => false,
        'optional' => true,
    ...
    'health' => [
        'key' => 'health',
        'name' => 'Health',
        'subtitle' => 'The Health service allows you to both validate and monitor your bapXdb server\'s health.',
        'description' => '/docs/services/health.md',
        'controller' => 'api/health.php',
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/server/health',
        'tests' => false,
        'optional' => true,
    ...
    'projects' => [
        'key' => 'projects',
        'name' => 'Projects',
        'subtitle' => 'The Project service allows you to manage all the projects in your bapXdb server.',
        'description' => '',
    ...
    'storage' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/client/storage',
        'tests' => false,
        'optional' => true,
    ...
    'teams' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/client/teams',
        'tests' => false,
        'optional' => true,
    ...
    'users' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/server/users',
        'tests' => false,
        'optional' => true,
    ...
    'sites' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/sites',
        'tests' => false,
        'optional' => true,
    ...
    'functions' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/functions',
        'tests' => false,
        'optional' => true,
    ...
    'proxy' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/proxy',
        'tests' => false,
        'optional' => false,
    ...
    'graphql' => [
        'key' => 'graphql',
        'name' => 'GraphQL',
        'subtitle' => 'The GraphQL API allows you to query and mutate your bapXdb server using GraphQL.',
        'description' => '/docs/services/graphql.md',
        'controller' => 'api/graphql.php',
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/graphql',
        'tests' => true,
        'optional' => true,
    ...
    'migrations' => [
        'key' => 'migrations',
        'name' => 'Migrations',
        'subtitle' => 'The Migrations service allows you to migrate third-party data to your bapXdb project.',
        'description' => '/docs/services/migrations.md',
        'controller' => 'api/migrations.php',
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/migrations',
        'tests' => true,
        'optional' => false,
    ...
    'messaging' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://bapxdb.io/docs/server/messaging',
        'tests' => true,
        'optional' => true,
