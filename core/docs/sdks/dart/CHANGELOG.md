...
**Full Changelog for bapXdb 1.0.0 can be found here**: https://github.com/bapxdb/bapxdb/blob/master/CHANGES.md
...
## 4.0.2
* Fix null issues with float attributes (https://github.com/bapxdb/sdk-for-dart/issues/17 and https://github.com/bapxdb/sdk-for-dart/issues/16)
...
- [Update membership roles](https://bapxdb.io/docs/references/cloud/server-dart/teams?sdk=dart#updateMembershipRoles)
...
- Added a custom bapXdb exception
