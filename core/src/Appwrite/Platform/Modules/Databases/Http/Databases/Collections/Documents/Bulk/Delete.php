...
namespace bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Documents\Bulk;

use bapXdb\Event\Event;
use bapXdb\Event\StatsUsage;
use bapXdb\Extend\Exception;
use bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Documents\Action;
...
class Delete extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('collectionId', '', new UID(), 'Collection ID. You can create a new collection using the Database service [server integration](https://bapxdb.io/docs/server/databases#databasesCreateCollection).')
            ->param('queries', [], new ArrayList(new Text(APP_LIMIT_ARRAY_ELEMENT_SIZE), APP_LIMIT_ARRAY_PARAMS_SIZE), 'Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://bapxdb.io/docs/queries). Maximum of ' . APP_LIMIT_ARRAY_PARAMS_SIZE . ' queries are allowed, each ' . APP_LIMIT_ARRAY_ELEMENT_SIZE . ' characters long.', true)
