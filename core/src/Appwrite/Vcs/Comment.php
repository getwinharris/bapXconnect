...
class Comment
{
    ...
    protected array $tips = [
        'bapXdb has crossed the 50K GitHub stars milestone with hundreds of active contributors',
        'Our Discord community has grown to 24K developers, and counting',
        'Sites auto-generate unique domains with the pattern https://randomstring.bapxdb.network',
    ...
    protected string $statePrefix = '[bapxdb]: #';
