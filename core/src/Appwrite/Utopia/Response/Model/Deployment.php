    ...
    public function __construct()
    {
        $this
            ...
            ->addRule('providerCommitHash', [
                'type' => self::TYPE_STRING,
                'description' => 'The change log entry hash of the vcs change log entry',
                'default' => '',
                'example' => '7c3f25d',
            ])
            ->addRule('providerCommitAuthorUrl', [
                'type' => self::TYPE_STRING,
                'description' => 'The url of vcs change log entry author',
                'default' => '',
                'example' => 'https://github.com/vermakhushboo',
            ])
            ->addRule('providerCommitAuthor', [
                'type' => self::TYPE_STRING,
                'description' => 'The name of vcs change log entry author',
                'default' => '',
                'example' => 'Khushboo Verma',
            ])
            ->addRule('providerCommitMessage', [
                'type' => self::TYPE_STRING,
                'description' => 'The change log entry message',
                'default' => '',
                'example' => 'Update index.js',
            ])
            ->addRule('providerCommitUrl', [
                'type' => self::TYPE_STRING,
                'description' => 'The url of the vcs change log entry',
                'default' => '',
            ...
            ->addRule('providerBranchUrl', [
                ...
                'description' => 'The branch of the vcs repository',
                'default' => '',
                'example' => 'https://github.com/vermakhushboo/bapxdb/tree/0.7.x',
            ]);
    }
