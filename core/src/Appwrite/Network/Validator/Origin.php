...
class Origin extends Validator
{
    ...
    public function getDescription(): string
    {
        ...
        if (empty($platform)) {
            return 'Invalid Scheme. The scheme used (' . $this->scheme . ') in the Origin (' . $this->origin . ') is not supported. If you are using a custom scheme, please change it to `bapxdb-callback-<PROJECT_ID>`';
        }
