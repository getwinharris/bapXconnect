...
namespace bapXdb\GraphQL\Types;

use bapXdb\GraphQL\Resolvers;
use bapXdb\GraphQL\Types;
...
class Mapper
{
    ...
    public static function param(
        ...
        switch ((!empty($validator)) ? $validator::class : '') {
            ...
            case 'bapXdb\Event\Validator\Event':
            case 'bapXdb\Event\Validator\FunctionEvent':
            case 'bapXdb\Network\Validator\CNAME':
            case 'bapXdb\Network\Validator\Email':
            case 'bapXdb\Network\Validator\Redirect':
            case 'bapXdb\Network\Validator\DNS':
            case 'bapXdb\Network\Validator\Origin':
            case 'bapXdb\Task\Validator\Cron':
