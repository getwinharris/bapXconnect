...
namespace bapXdb\Platform\Modules\Functions\Http\Deployments;
...
class Create extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->label('sdk', new Method(
                ...
                This endpoint accepts a tar.gz file compressed with your code. Make sure to include any dependencies your code has within the compressed file. You can learn more about code packaging in the [bapXdb Cloud Functions tutorial](https://bapxdb.io/docs/functions).
            ...
            ->param('code', [], new File(), 'Gzip file with your code package. When used with the bapXdb CLI, pass the path to your code directory, and the CLI will automatically package your code. Use a path that is within the current directory.', skipValidation: true)
    ...
    public function action(
        ...
        if (!empty($contentRange)) {
            ...
            $deploymentId = $request->getHeader('x-bapxdb-id', $deploymentId);
