...
namespace bapXdb\Platform\Modules\Databases\Http\TablesDB\Tables\Rows;

use bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Documents\Create as DocumentCreate;
use bapXdb\SDK\AuthType;
use bapXdb\SDK\ContentType;
use bapXdb\SDK\Method;
use bapXdb\SDK\Parameter;
...
class Create extends DocumentCreate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('tableId', '', new UID(), 'Table ID. You can create a new table using the Database service [server integration](https://bapxdb.io/docs/references/cloud/server-dart/tablesDB#createTable). Make sure to define columns before creating rows.')
            ...
            ->param('permissions', null, new Nullable(new Permissions(APP_LIMIT_ARRAY_PARAMS_SIZE, [Database::PERMISSION_READ, Database::PERMISSION_UPDATE, Database::PERMISSION_DELETE, Database::PERMISSION_WRITE])), 'An array of permissions strings. By default, only the current user is granted all permissions. [Learn more about permissions](https://bapxdb.io/docs/permissions).', true)
