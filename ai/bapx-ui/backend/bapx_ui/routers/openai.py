...
from bapx_ui.utils.payload import (
...
async def get_headers_and_cookies(
    ...
    headers = {
        ...
        **(
            {
                "HTTP-Referer": "https://openbapx_ui.com/",
                "X-Title": "bapX UI",
            }
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else "bapX UI: Server Connection Error",
            )
    ...
    if url_idx is None:
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail="bapX UI: Server Connection Error"
                )
            except Exception as e:
...
async def generate_chat_completion(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail="bapX UI: Server Connection Error",
        )
    finally:
        if not streaming:
