...
use bapXdb\GraphQL\Promises\Adapter\Swoole;
use bapXdb\Hooks\Hooks;
use bapXdb\PubSub\Adapter\Redis as PubSub;
use bapXdb\URL\URL as bapXdbURL;
...
$register->set('logger', function () {
    ...
    try {
        ...
        // Fallback for older bapXdb versions up to 1.5.x that use _APP_LOGGING_PROVIDER and _APP_LOGGING_CONFIG environment variables
...
$register->set('pools', function () {
    ...
    $fallbackForDB = 'db_main=' . bapXdbURL::unparse([
        'scheme' => 'mariadb',
    ...
    $fallbackForRedis = 'redis_main=' . bapXdbURL::unparse([
        'scheme' => 'redis',
