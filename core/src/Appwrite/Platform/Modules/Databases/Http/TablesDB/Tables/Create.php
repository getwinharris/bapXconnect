...
use bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Create as CollectionCreate;
...
class Create extends CollectionCreate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('rowSecurity', false, new Boolean(true), 'Enables configuring permissions for individual rows. A user needs one of row or table level permissions to access a row. [Learn more about permissions](https://bapxdb.io/docs/permissions).', true)
