...
namespace bapXdb\Platform\Workers;
...
class Functions extends Action
{
            ...
            while ($sum >= $limit) {
                ...
                foreach ($functions as $function) {
                    ...
                    $this->execute(
                        ...
                        method: 'POST',
                        headers: [
                            'user-agent' => 'bapXdb/' . APP_VERSION_STABLE,
    ...
    private function fail(
        ...
        $headers['x-bapxdb-trigger'] = $trigger;
        $headers['x-bapxdb-event'] = $event ?? '';
    ...
    private function execute(
        ...
        if ($version === 'v2') {
            $vars = \array_merge($vars, [
                ...
                'APPWRITE_FUNCTION_EVENT' => $headers['x-bapxdb-event'] ?? '',
