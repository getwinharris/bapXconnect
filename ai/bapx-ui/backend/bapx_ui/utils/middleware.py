...
from bapx_ui.utils.misc import is_string_allowed
from bapx_ui.models.oauth_sessions import OAuthSessions
from bapx_ui.models.chats import Chats
from bapx_ui.models.folders import Folders
from bapx_ui.models.users import Users
from bapx_ui.socket.main import (
    get_event_call,
    get_event_emitter,
)
from bapx_ui.routers.tasks import (
    generate_queries,
    generate_title,
    generate_follow_ups,
...
from bapx_ui.routers.images import (
    image_generations,
    CreateImageForm,
    image_edits,
    EditImageForm,
)
from bapx_ui.routers.pipelines import (
    process_pipeline_inlet_filter,
    process_pipeline_outlet_filter,
)
from bapx_ui.routers.memories import query_memory, QueryMemoryForm

from bapx_ui.utils.webhook import post_webhook
from bapx_ui.utils.files import (
...
from bapx_ui.models.users import UserModel
from bapx_ui.models.functions import Functions
from bapx_ui.models.models import Models

from bapx_ui.retrieval.utils import get_sources_from_items


from bapx_ui.utils.chat import generate_chat_completion
from bapx_ui.utils.task import (
    get_task_model_id,
    rag_template,
...
from bapx_ui.utils.tools import get_tools, get_updated_tool_function
from bapx_ui.utils.plugin import load_function_module_by_id
from bapx_ui.utils.filter import (
    get_sorted_filter_ids,
    process_filter_functions,
)
from bapx_ui.utils.code_interpreter import execute_code_jupyter
from bapx_ui.utils.payload import apply_system_prompt_to_body
from bapx_ui.utils.mcp.client import MCPClient
...
from bapx_ui.constants import TASKS
                            ...
                            if not Users.is_user_active(user.id):
                                ...
                                if webhook_url:
                                    await post_webhook(
                                        ...
                                        webhook_url,
                                        f"{title} - {request.app.state.config.BAPX_UI_URL}/c/{metadata['chat_id']}\n\n{content}",
                                        {
                                            "action": "chat",
                                            "message": content,
                                            "title": title,
                                            "url": f"{request.app.state.config.BAPX_UI_URL}/c/{metadata['chat_id']}",
                                        },
                                    )
