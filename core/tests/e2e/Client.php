...
class Client
{
     ...
     * @var string
     */
    protected $endpoint = 'https://bapxdb.test/v1';
    ...
    protected $headers = [
        'content-type' => '',
        'x-sdk-version' => 'bapxdb:php:v1.0.7',
    ];
     ...
     * Set Project
     *
     * Your bapXdb project ID. You can find your project ID in your bapXdb console project settings.
     *
     * @param string $value
     *
     * @return self $this
    ...
    {
        $this->addHeader('X-bapXdb-Project', $value);
     ...
     * Set Key
     *
     * Your bapXdb project secret key. You can can create a new API key from your bapXdb console API keys dashboard.
     *
     * @param string $value
     *
     * @return self $this
    ...
    {
        $this->addHeader('X-bapXdb-Key', $value);
    ...
    {
        $this->addHeader('X-bapXdb-Locale', $value);
    ...
    {
        $this->addHeader('X-bapXdb-Mode', $value);
    ...
    {
        $this->addHeader('X-bapXdb-Response-Format', $value);
