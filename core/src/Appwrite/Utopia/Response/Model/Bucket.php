...
class Bucket extends Model
{
    public function __construct()
    {
        $this
            ...
            ->addRule('$permissions', [
                'type' => self::TYPE_STRING,
                'description' => 'Bucket permissions. [Learn more about permissions](https://bapxdb.io/docs/permissions).',
                'default' => [],
                'example' => ['read("any")'],
                'array' => true,
            ])
            ->addRule('fileSecurity', [
                ...
                'description' => 'Whether file-level security is enabled. [Learn more about permissions](https://bapxdb.io/docs/permissions).',
                'default' => false,
                'example' => true,
            ])
            ->addRule('name', [
