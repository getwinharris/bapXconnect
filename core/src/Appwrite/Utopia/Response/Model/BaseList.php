    ...
    public function __construct(
        ...
        if ($paging) {
            ...
            if (\in_array($name, $namesWithCap)) {
                $description = 'Total number of ' . $key . ' that matched your query used as reference for offset pagination. When the `total` number of ' . $key . ' rows available is greater than 5000, total returned will be capped at 5000, and cursor pagination should be used. Read more about [pagination](https://bapxdb.io/docs/pagination).';
            } else {
