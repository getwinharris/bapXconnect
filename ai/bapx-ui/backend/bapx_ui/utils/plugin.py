...
from bapx_ui.env import PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
from bapx_ui.models.functions import Functions
from bapx_ui.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from bapx_ui.utils",
        "from apps": "from bapx_ui.apps",
        "from main": "from bapx_ui.main",
        "from config": "from bapx_ui.config",
    }
