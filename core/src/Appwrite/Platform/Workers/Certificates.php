        ...
        if (!$isMainDomain) {
            ...
            if (!empty(System::getEnv('_APP_DOMAIN_TARGET_CAA', ''))) {
                ...
                if (!$validator->isValid($domain->get())) {
                    ...
                    throw new Exception('Failed to verify domain DNS records. CAA records do not allow bapXdb\'s certificate issuer.');
                }
            }
        } else {
