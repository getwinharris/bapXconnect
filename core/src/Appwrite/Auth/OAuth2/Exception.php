...
class Exception extends bapXdbException
{
    ...
    public function __construct(string $response = '', int $code = 0, \Throwable $previous = null)
    {
        ...
        $type = match ($code) {
            400 => bapXdbException::USER_OAUTH2_BAD_REQUEST,
            401 => bapXdbException::USER_OAUTH2_UNAUTHORIZED,
            default => bapXdbException::USER_OAUTH2_PROVIDER_ERROR
        };
