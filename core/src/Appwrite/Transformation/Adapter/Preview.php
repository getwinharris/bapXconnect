...
class Preview extends Adapter
{
    ...
    public function transform(): void
    {
        ...
        $banner = <<<EOT
        <link rel="preconnect" href="https://assets.bapxdb.io/" crossorigin>
        <style>
            @font-face {
                font-family: 'Inter';
                src: url('https://assets.bapxdb.io/fonts/inter/Inter-Regular.woff2') format('woff2');
                font-weight: 400;
                font-style: normal;
                font-display: swap;
            }
            @font-face {
                font-family: 'Inter';
                src: url('https://assets.bapxdb.io/fonts/inter/Inter-Medium.woff2') format('woff2');
                font-weight: 500;
                font-style: normal;
                font-display: swap;
            }
        ...
        <style>
            ...
            #bapxdb-preview-logo-dark {
                display: none;
            }

            #bapxdb-preview:hover #bapxdb-preview-close {
                opacity: 1;
            }
            ...
            #bapxdb-preview-close:hover #bapxdb-preview-close-text {
                opacity: 1;
            }   
        ...
        <button id="bapxdb-preview">
            <p id="bapxdb-preview-text">Preview by</p>

                <div id="bapxdb-preview-close">
                    ...
                    <p id="bapxdb-preview-close-text">Hide</p>
                </div>

                <svg id="bapxdb-preview-logo-light" width="65" height="12" viewBox="0 0 65 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg id="bapxdb-preview-logo-dark" width="65" height="12" viewBox="0 0 65 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <script>
            (function() {
                var banner = document.getElementById("bapxdb-preview");
