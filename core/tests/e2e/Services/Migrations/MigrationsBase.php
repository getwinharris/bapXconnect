...
trait MigrationsBase
{
    ...
    {
        $migration = $this->client->call(Client::METHOD_POST, '/migrations/bapxdb', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $this->getDestinationProject()['$id'],
            'x-bapxdb-key' => $this->getDestinationProject()['apiKey'],
        ], $body);
    ...
    /**
     * bapXdb E2E Migration Tests
     */
    public function testCreatebapXdbMigration(): void
    {
        $response = $this->performMigrationSync([
            'resources' => bapXdb::getSupportedResources(),
            'endpoint' => $this->endpoint,
            'projectId' => $this->getProject()['$id'],
            'apiKey' => $this->getProject()['apiKey'],
        ]);

        $this->assertEquals(bapXdb::getSupportedResources(), $response['resources']);
        $this->assertEquals('bapXdb', $response['source']);
        $this->assertEquals('bapXdb', $response['destination']);
     ...
     * Auth
     */
    public function testbapXdbMigrationAuthUserPassword(): void
    {
    ...
    public function testbapXdbMigrationAuthUserPhone(): void
    {
        $response = $this->client->call(Client::METHOD_POST, '/users', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $this->getProject()['$id'],
    ...
    public function testbapXdbMigrationAuthTeam(): void
    {
     ...
     * Databases
     */
    public function testbapXdbMigrationDatabase(): array
    {
    ...
    /**
     * @depends testbapXdbMigrationDatabase
     */
    public function testbapXdbMigrationDatabasesTable(array $data): array
    {
    ...
    /**
     * @depends testbapXdbMigrationDatabasesTable
     */
    public function testbapXdbMigrationDatabasesRow(array $data): void
    {
        $table = $data['tableId'];
        $databaseId = $data['databaseId'];
     ...
     * Storage
     */
    public function testbapXdbMigrationStorageBucket(): void
    {
    ...
    public function testbapXdbMigrationStorageFiles(): void
    {
        $bucket = $this->client->call(Client::METHOD_POST, '/storage/buckets', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $this->getProject()['$id'],
     ...
     * Functions
     */
    public function testbapXdbMigrationFunction(): void
    {
    ...
    public function testCreateCSVImport(): void
    {
        ...
        $this->assertEventually(function () use ($missingColumn, $databaseId, $tableId) {
            ...
            $this->assertEquals('bapXdb', $migration['body']['destination']);
    ...
    public function testCreateCSVExport(): void
    {
        ...
        $this->assertEventually(function () use ($migrationId) {
            ...
            $this->assertEquals('completed', $response['body']['status']);
            $this->assertEquals('bapXdb', $response['body']['source']);
