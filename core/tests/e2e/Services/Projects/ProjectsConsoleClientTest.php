...
class ProjectsConsoleClientTest extends Scope
{
    ...
    public function testUpdateProjectSMTP($data): array
    {
        ...
        $this->assertEquals('mailer@bapxdb.io', $response['body']['smtpSenderEmail']);
    ...
    public function testCreateProjectSMTPTests(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_POST, '/projects/' . $id . '/smtp/tests', array_merge([
            ...
            'emails' => ['testuser@bapxdb.io', 'testusertwo@bapxdb.io'],
            'senderEmail' => 'custommailer@bapxdb.io',
            'senderName' => 'Custom Mailer',
            'replyTo' => 'reply@bapxdb.io',
            'host' => 'maildev',
            'port' => 1025,
            'username' => '',
            'password' => '',
        ...
        $this->assertEquals('custommailer@bapxdb.io', $emails[0]['from'][0]['address']);
        $this->assertEquals('Custom Mailer', $emails[0]['from'][0]['name']);
        $this->assertEquals('reply@bapxdb.io', $emails[0]['replyTo'][0]['address']);
        ...
        $this->assertEquals('testuser@bapxdb.io', $to[0]);
        $this->assertEquals('testusertwo@bapxdb.io', $to[1]);

        $response = $this->client->call(Client::METHOD_POST, '/projects/' . $id . '/smtp/tests', array_merge([
            'content-type' => 'application/json',
            'x-bapxdb-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'emails' => ['u1@bapxdb.io', 'u2@bapxdb.io', 'u3@bapxdb.io', 'u4@bapxdb.io', 'u5@bapxdb.io', 'u6@bapxdb.io', 'u7@bapxdb.io', 'u8@bapxdb.io', 'u9@bapxdb.io', 'u10@bapxdb.io'],
            'senderEmail' => 'custommailer@bapxdb.io',
            'senderName' => 'Custom Mailer',
            'replyTo' => 'reply@bapxdb.io',
            'host' => 'maildev',
        ...
        $response = $this->client->call(Client::METHOD_POST, '/projects/' . $id . '/smtp/tests', array_merge([
            ...
            'emails' => ['u1@bapxdb.io', 'u2@bapxdb.io', 'u3@bapxdb.io', 'u4@bapxdb.io', 'u5@bapxdb.io', 'u6@bapxdb.io', 'u7@bapxdb.io', 'u8@bapxdb.io', 'u9@bapxdb.io', 'u10@bapxdb.io', 'u11@bapxdb.io'],
            'senderEmail' => 'custommailer@bapxdb.io',
            'senderName' => 'Custom Mailer',
            'replyTo' => 'reply@bapxdb.io',
            'host' => 'maildev',
    ...
    public function testUpdateTemplates($data): array
    {
        ...
        $response = $this->client->call(Client::METHOD_PATCH, '/projects/' . $id . '/templates/email/verification/en-us', array_merge([
            ...
            'senderName' => 'bapXdb Custom',
            'senderEmail' => 'custom@bapxdb.io',
        ]);

        $this->assertEquals(200, $response['headers']['status-code']);
        $this->assertEquals('Please verify your email', $response['body']['subject']);
        $this->assertEquals('bapXdb Custom', $response['body']['senderName']);
        $this->assertEquals('custom@bapxdb.io', $response['body']['senderEmail']);
        $this->assertEquals('verification', $response['body']['type']);
        $this->assertEquals('en-us', $response['body']['locale']);
    ...
    public function testCreateProjectWebhook($data): array
    {
        ...
        $this->assertEquals('https://bapxdb.io', $response['body']['url']);
    ...
    public function testUpdateProjectWebhook($data): array
    {
        ...
        $this->assertEquals('https://bapxdb.io/new', $response['body']['url']);
        $this->assertIsBool($response['body']['security']);
    ...
    public function testValidateProjectKey($data): void
    {
        ...
        $response = $this->client->call(Client::METHOD_POST, '/users', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $projectId,
            'x-bapxdb-key' => $response['body']['secret']
        ], [
            'userId' => ID::unique(),
        ]);
    ...
    public function testCreateProjectPlatform($data): array
    {
        ...
        $this->assertEquals('', $response['body']['key']);
        $this->assertEquals('', $response['body']['store']);
        $this->assertEquals('flutter.bapxdb.io', $response['body']['hostname']);
    ...
    public function testUpdateProjectPlatform($data): array
    {
        ...
        $this->assertEquals('', $response['body']['key']);
        $this->assertEquals('', $response['body']['store']);
        $this->assertEquals('flutter2.bapxdb.io', $response['body']['hostname']);
    ...
    public function testDeleteSharedProject(): void
    {
        ...
        $user1 = $this->client->call(Client::METHOD_POST, '/users', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $project1Id,
            'x-bapxdb-key' => $key1['body']['secret'],
        ], [
            'userId' => ID::unique(),
            'email' => 'test1@bapxdb.io',
            'password' => 'password',
        ]);
        ...
        $user2 = $this->client->call(Client::METHOD_POST, '/users', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $project2Id,
            'x-bapxdb-key' => $key2['body']['secret'],
        ], [
            'userId' => ID::unique(),
            'email' => 'test2@bapxdb.io',
            'password' => 'password',
        ]);
    ...
    public function testCreateProjectVariable(array $data)
    {
        ...
        $variable = $this->client->call(Client::METHOD_POST, '/project/variables', array_merge([
            'content-type' => 'application/json',
            'x-bapxdb-project' => $data['projectId'],
            'x-bapxdb-mode' => 'admin',
        ], $this->getHeaders()), [
            'key' => 'APP_TEST',
            'value' => 'TESTINGVALUE',
    ...
    public function testGetDevKeyWithSdks(): void
    {
        ...
        $res = $this->client->call(Client::METHOD_POST, '/account/sessions/email', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $projectId,
            'x-bapxdb-dev-key' => $devKey['secret'],
            'x-sdk-name' => 'python'
        ], [
            'email' => 'user@bapxdb.io',
            'password' => 'password'
        ]);
    ...
    public function testNoRateLimitWithDevKey(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_POST, '/account/sessions/email', [
            'content-type' => 'application/json',
            'x-bapxdb-project' => $projectId,
            'x-bapxdb-dev-key' => $response['body']['secret']
        ], [
            'email' => 'user@bapxdb.io',
            'password' => 'password'
        ]);
