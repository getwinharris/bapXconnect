...
class Table extends Model
{
    public function __construct()
    {
        $this
            ...
            ->addRule('$permissions', [
                'type' => self::TYPE_STRING,
                'description' => 'Table permissions. [Learn more about permissions](https://bapxdb.io/docs/permissions).',
                'default' => '',
                'example' => ['read("any")'],
                'array' => true
            ])
            ...
            ->addRule('rowSecurity', [
                'type' => self::TYPE_BOOLEAN,
                'description' => 'Whether row-level permissions are enabled. [Learn more about permissions](https://bapxdb.io/docs/permissions).',
                'default' => '',
                'example' => true,
            ])
            ->addRule('columns', [
