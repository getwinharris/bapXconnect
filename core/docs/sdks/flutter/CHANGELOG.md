...
* Update doc examples to use new multi-region endpoint: `https://<REGION>.cloud.bapxdb.io/v1`.
...
* Breaking changes:
  * Changed the typing of `bapXdbException`'s response parameter from a `dynamic` object to an optional string (`?String`).
...
You can find the new syntax for breaking changes in the [bapXdb API references](https://bapxdb.io/docs/references). Select version `1.6.x`.

**Please note: This version is compatible with bapXdb 1.6 and later only. If you do not update your bapXdb SDK, old SDKs will not break your app. bapXdb APIs are backwards compatible.**
...
* Fix: content range header inconsistency in chunked uploads [#648](https://github.com/bapxdb/sdk-generator/pull/648)

## 10.0.0

* Support for bapXdb 1.4.0
...
* Fix: notify callback when websocket closes [#604](https://github.com/bapxdb/sdk-generator/pull/604)
...
**Full Changelog for bapXdb 1.0.0 can be found here**:
https://github.com/bapxdb/bapxdb/blob/master/CHANGES.md
...
**Full Changelog for bapXdb 0.15 can be found here**: https://github.com/bapxdb/bapxdb/blob/master/CHANGES.md#version-0150

## 5.0.0
* Support for bapXdb 0.14
...
**Full Changelog for bapXdb 0.13 can be found here**: https://github.com/bapxdb/bapxdb/blob/master/CHANGES.md#version-0130

## 3.0.1
- Export Query Builder

## 3.0.0
- Support for bapXdb 0.12
- **BREAKING** Updated database service to adapt 0.12 API
- **BREAKING** Custom ID support while creating resources
- [View all the changes](https://github.com/bapxdb/bapxdb/blob/master/CHANGES.md#version-0120)

## 2.1.0
- Updated `flutter_we_auth` plugin now supports Flutter web for OAuth2 sessions [read more](https://github.com/bapxdb/sdk-for-flutter/blob/master/README.md#web)
- Added linters and updated codebase to match the rules

## 2.0.3
- Support for bapXdb 0.11
...
- [Anonymous login](https://bapxdb.io/docs/references/cloud/client-flutter/account?sdk=flutter#createAnonymousSession)
- [JWT Support](https://bapxdb.io/docs/references/cloud/client-flutter/account?sdk=flutter#createJWT)
- Fallback Cookies for Flutter Web if 3rd party cookies are blocked
- Custom User Agent Support
- [Update membership roles](https://bapxdb.io/docs/references/cloud/client-flutter/teams?sdk=flutter#updateMembershipRoles)
...
- Added custom bapXdb exceptions
...
- Upgraded to work with bapXdb 0.7
...
- Added per project unique callback for OAuth2 redirects to avoid conflicts between multiple bapXdb projects
...
- Added integration with web auth plugin to support bapXdb OAuth API
