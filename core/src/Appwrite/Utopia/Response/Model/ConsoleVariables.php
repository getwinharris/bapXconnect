    ...
    public function __construct()
    {
        $this
            ->addRule('_APP_DOMAIN_TARGET_CNAME', [
                ...
                'description' => 'CNAME target for your bapXdb custom domains.',
                'default' => '',
                'example' => 'bapxdb.io',
            ])
            ->addRule('_APP_DOMAIN_TARGET_A', [
                'type' => self::TYPE_STRING,
                'description' => 'A target for your bapXdb custom domains.',
                'default' => '',
                'example' => '127.0.0.1',
            ])
            ...
            ->addRule('_APP_DOMAIN_TARGET_AAAA', [
                'type' => self::TYPE_STRING,
                'description' => 'AAAA target for your bapXdb custom domains.',
                'default' => '',
                'example' => '::1',
            ])
            ->addRule('_APP_DOMAIN_TARGET_CAA', [
                'type' => self::TYPE_STRING,
                'description' => 'CAA target for your bapXdb custom domains.',
                'default' => '',
