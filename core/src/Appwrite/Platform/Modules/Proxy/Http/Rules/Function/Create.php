...
namespace bapXdb\Platform\Modules\Proxy\Http\Rules\Function;

use bapXdb\Event\Certificate;
use bapXdb\Event\Event;
use bapXdb\Extend\Exception;
use bapXdb\Platform\Modules\Proxy\Http\Rules\Action;
    ...
    public function __construct(...$params)
    {
        ...
        $this
            ...
            ->label('sdk', new Method(
                ...
                description: <<<EOT
                Create a new proxy rule for executing bapXdb Function on custom domain.
                EOT,
                auth: [AuthType::ADMIN],
                responses: [
                    new SDKResponse(
