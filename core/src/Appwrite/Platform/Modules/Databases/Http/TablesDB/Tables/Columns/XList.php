...
namespace bapXdb\Platform\Modules\Databases\Http\TablesDB\Tables\Columns;

use bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Attributes\XList as AttributesXList;
use bapXdb\SDK\AuthType;
use bapXdb\SDK\Method;
use bapXdb\SDK\Response as SDKResponse;
use bapXdb\Utopia\Database\Validator\Queries\Columns;
...
class XList extends AttributesXList
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('queries', [], new Columns(), 'Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://bapxdb.io/docs/queries). Maximum of ' . APP_LIMIT_ARRAY_PARAMS_SIZE . ' queries are allowed, each ' . APP_LIMIT_ARRAY_ELEMENT_SIZE . ' characters long. You may filter on the following columns: ' . implode(', ', Columns::ALLOWED_COLUMNS), true)
