...
namespace bapXdb\Platform\Modules\Databases\Http\Databases\Collections\Attributes\Boolean;
...
class Create extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('collectionId', '', new UID(), 'Collection ID. You can create a new table using the Database service [server integration](https://bapxdb.io/docs/server/databases#databasesCreateCollection).')
