...
class Platform
{
    ...
    public const SCHEME_IOS = 'bapxdb-ios';
    public const SCHEME_MACOS = 'bapxdb-macos';
    public const SCHEME_WATCHOS = 'bapxdb-watchos';
    public const SCHEME_TVOS = 'bapxdb-tvos';
    public const SCHEME_ANDROID = 'bapxdb-android';
    public const SCHEME_WINDOWS = 'bapxdb-windows';
    public const SCHEME_LINUX = 'bapxdb-linux';
