...
namespace bapXdb\Platform\Modules\Functions\Http\Deployments\Template;
    ...
    public function __construct()
    {
        $this
            ...
            ->label('sdk', new Method(
                ...
                Use this endpoint with combination of [listTemplates](https://bapxdb.io/docs/products/functions/templates) to find the template details.
                EOT,
