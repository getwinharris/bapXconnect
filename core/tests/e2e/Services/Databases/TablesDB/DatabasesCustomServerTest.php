...
class DatabasesCustomServerTest extends Scope
{
    ...
    public function testColumnUpdateString(array $data)
    {
        ...
        $this->assertEquals(400, $update['headers']['status-code']);
        $this->assertEquals(bapXdbException::COLUMN_DEFAULT_UNSUPPORTED, $update['body']['type']);
    }
    ...
    public function testColumnUpdateEmail(array $data)
    {
        ...
        $this->assertNotNull($column);
        $this->assertFalse($column['required']);
        $this->assertEquals('torsten@bapxdb.io', $column['default']);
    ...
    public function testColumnUpdateUrl(array $data)
    {
        ...
        $this->assertNotNull($column);
        $this->assertFalse($column['required']);
        $this->assertEquals('http://bapxdb.io', $column['default']);
    ...
    public function testColumnUpdateInteger(array $data)
    {
        ...
        $this->assertEquals(400, $update['headers']['status-code']);
        $this->assertEquals(bapXdbException::COLUMN_VALUE_INVALID, $update['body']['type']);
    ...
    public function testColumnUpdateStringResize(array $data)
    {
        ...
        $this->assertEquals(bapXdbException::COLUMN_INVALID_RESIZE, $column['body']['type']);
        ...
        $this->assertEquals(bapXdbException::ROW_INVALID_STRUCTURE, $newDoc['body']['type']);
    }
    ...
    public function testColumnUpdateNotFound(array $data)
    {
        ...
        foreach ($columns as $key => $payload) {
            ...
            $this->assertEquals(404, $update['headers']['status-code']);
            $this->assertEquals(bapXdbException::TABLE_NOT_FOUND, $update['body']['type']);
            ...
            $this->assertEquals(404, $update['headers']['status-code']);
            $this->assertEquals(bapXdbException::COLUMN_NOT_FOUND, $update['body']['type']);
        }
    }
