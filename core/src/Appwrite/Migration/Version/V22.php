...
namespace bapXdb\Migration\Version;

use bapXdb\Migration\Migration;
use Exception;
use Throwable;
    ...
    private function migrateDocument(Document $document): Document
    {
        switch ($document->getCollection()) {
            case 'rules':
                ...
                8. Fill "owner" with "bapXdb" if "domain" ends with "functions" or "sites"
                ...
                */
                ...
                if (
                    ...
                    $document->setAttribute('owner', 'bapXdb');
                }
