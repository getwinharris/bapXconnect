<script>
	...
	import { BAPX_UI_NAME, config } from '$lib/stores';
			...
			<div class="m-auto pb-44 flex flex-col justify-center">
				<div class="max-w-md">
					<div class="text-center text-2xl font-medium z-50">
						{$i18n.t('{{webUIName}} Backend Required', { webUIName: $BAPX_UI_NAME })}
					</div>
					...
					<div class=" mt-4 text-center text-sm w-full">
						...
						<a
							...
							href="https://github.com/bapx-ui/bapx-ui#how-to-install-"
