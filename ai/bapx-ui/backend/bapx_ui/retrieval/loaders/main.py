...
from bapx_ui.retrieval.loaders.external_document import ExternalDocumentLoader

from bapx_ui.retrieval.loaders.mistral import MistralLoader
from bapx_ui.retrieval.loaders.datalab_marker import DatalabMarkerLoader
from bapx_ui.retrieval.loaders.mineru import MinerULoader
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if not api_base_url or api_base_url.strip() == "":
                api_base_url = "https://www.datalab.to/api/v1/marker"  # https://github.com/bapx-ui/bapx-ui/pull/16867#issuecomment-3218424349
