...
class VCSConsoleClientTest extends Scope
{
    ...
    public string $providerInstallationId = '42954928'; // bapxdb-test
    ...
    public function testGetInstallation(string $installationId): void
    {
        ...
        $this->assertEquals('bapxdb-test', $installation['body']['organization']);
    }
    ...
    public function testListRepositories(string $installationId): void
    {
        ...
        $this->assertEquals($repositories['body']['runtimeProviderRepositories'][0]['organization'], 'bapxdb-test');
        ...
        $this->assertEquals(200, $searchedRepositories['headers']['status-code']);
        $this->assertEquals($searchedRepositories['body']['total'], 1);
        $this->assertEquals($searchedRepositories['body']['runtimeProviderRepositories'][0]['name'], 'bapxdb');
        ...
        $this->assertEquals($repositories['body']['frameworkProviderRepositories'][0]['organization'], 'bapxdb-test');
        ...
        $this->assertSame('bapxdb', $repositories['body']['runtimeProviderRepositories'][0]['name']);
    ...
    public function testGetRepository(string $installationId): void
    {
        ...
        $this->assertEquals($repository['body']['organization'], 'bapxdb-test');
    ...
    public function testCreateRepository(string $installationId): void
    {
        ...
        $this->assertEquals('bapxdb-test', $repository['body']['organization']);
        ...
        $result = $github->deleteRepository('bapxdb-test', 'test-repo-1');
