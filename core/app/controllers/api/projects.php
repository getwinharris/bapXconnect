...
use Ahc\Jwt\JWT;
use bapXdb\Auth\Validator\MockNumber;
use bapXdb\Bapx\BaseDB;
use bapXdb\Event\Delete;
use bapXdb\Event\Mail;
use bapXdb\Event\Validator\Event;
...
use bapXdb\Utopia\Database\Validator\ProjectId;
use bapXdb\Utopia\Database\Validator\Queries\Projects;
...
App::post('/v1/projects')
    ...
    ->action(function (string $projectId, string $name, string $teamId, string $region, string $description, string $logo, string $url, string $legalName, string $legalCountry, string $legalState, string $legalCity, string $legalAddress, string $legalTaxId, Request $request, Response $response, Database $dbForPlatform, Cache $cache, Group $pools, Hooks $hooks) {
        ...
        try {
            ...
            // Initialize BaseDB (BAPX) project storage
            $baseDB = new BaseDB();
            $baseDB->initProject($project->getSequence());
        } catch (Duplicate) {
