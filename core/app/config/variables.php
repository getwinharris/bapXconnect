...
return [
    [
        ...
        'variables' => [
            ...
            [
                'name' => '_APP_LOCALE',
                'description' => 'Set your bapXdb\'s locale. By default, the locale is set to \'en\'.',
                'introduction' => '',
                'default' => 'en',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This is your server private secret key that is used to encrypt all sensitive data on your server. bapXdb server encrypts all secret data on your server like webhooks, HTTP passwords, user sessions, and storage files. The var is not set by default, if you wish to take advantage of bapXdb encryption capabilities you should change it and make sure to **keep it a secret and have a backup for it**.',
                'introduction' => '',
            ...
            [
                'name' => '_APP_DOMAIN',
                'description' => 'Your bapXdb domain address. When setting a public suffix domain, bapXdb will attempt to issue a valid SSL certificate automatically. When used with a dev domain, bapXdb will assign a self-signed SSL certificate. The default value is \'localhost\'. Multiple domains can be separated by commas.',
                'introduction' => '',
                'default' => 'localhost',
                'required' => true,
                'question' => 'Enter your bapXdb hostname',
                'filter' => ''
            ],
            [
            ...
            [
                ...
                'description' => 'Deprecated since 1.7.0. A DNS A record hostname to serve as a CNAME target for your bapXdb custom domains. You can use the same value as used for the bapXdb \'_APP_DOMAIN\' variable. The default value is \'localhost\'.',
                'introduction' => '',
                'default' => 'localhost',
                'required' => true,
                'question' => 'Enter a DNS A record hostname to serve as a CNAME for your custom domains.' . PHP_EOL . 'You can use the same value as used for the bapXdb hostname.',
                'filter' => 'domainTarget'
            ],
            [
                'name' => '_APP_DOMAIN_TARGET_CNAME',
                'description' => 'A domain that can be used as DNS CNAME record to point to instance of bapXdb server.',
                'introduction' => '',
                'default' => 'localhost',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'An IPv6 that can be used as DNS AAAA record to point to instance of bapXdb server.',
                'introduction' => '',
                'default' => '::1',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'An IPV4 that can be used as DNS A record to point to instance of bapXdb server.',
                'introduction' => '',
                'default' => '127.0.0.1',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This option allows you to disable the creation of new users on the bapXdb console. When enabled only 1 user will be able to use the registration form. New users can be added by inviting them to your project. By default this option is enabled.',
                'introduction' => '0.8.0',
                'default' => 'enabled',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This option allows you to limit creation of new users on the bapXdb console. This option is very useful for small teams or sole developers. To enable it, pass a list of allowed email addresses separated by a comma.',
                'introduction' => '',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => "This last option allows you to limit creation of users in bapXdb console for users sharing the same set of IP addresses. This option is very useful for team working with a VPN service or a company IP.\n\nTo enable/activate this option, pass a list of allowed IP addresses separated by a comma.",
                'introduction' => '',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This option allows you to add additional hostnames to your bapXdb console. This option is very useful for allowing access to the console project from additional domains. To enable it, pass a list of allowed hostnames separated by a comma.',
                'introduction' => '1.5.0',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This is the sender name value that will appear on email messages sent to developers from the bapXdb console. The default value is: \'bapXdb\'. You can use url encoded strings for spaces and special chars.',
                'introduction' => '0.7.0',
                'default' => 'bapXdb',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This is the sender email address that will appear on email messages sent to developers from the bapXdb console. The default value is \'noreply@bapxdb.io\'. You should choose an email address that is allowed to be used from your SMTP server to avoid the server email ending in the users\' SPAM folders.',
                'introduction' => '0.7.0',
                'default' => 'noreply@bapxdb.io',
                'required' => false,
                'question' => '',
                'filter' => ''
            ],
            [
                ...
                'description' => 'This is the sender email address that will appear in the generated specs. The default value is \'team@bapxdb.io\'.',
                'introduction' => '1.6.0',
                'default' => 'team@bapxdb.io',
                'required' => false,
                'question' => '',
                'filter' => ''
            ],
            [
                ...
                'description' => 'Use this environment variable to set the default bapXdb HTTP response format to support an older version of bapXdb. This option is useful to overcome breaking changes between versions. You can also use the `X-bapXdb-Response-Format` HTTP request header to overwrite the response for a specific request. This variable accepts any valid bapXdb version. To use the current version format, leave the value of the variable empty.',
                'introduction' => '0.7.0',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'Interval value containing the number of seconds that the bapXdb usage process should wait before aggregating stats and syncing it to Database from TimeSeries data. The default value is 30 seconds. Reintroduced in 1.1.0.',
                'introduction' => '1.1.0',
                'default' => '30',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This option allows you configure if a new login in the bapXdb Console should send an alert email to the user. It\'s disabled by default with value "disabled", and to enable it, pass value "enabled".',
                'introduction' => '1.6.0',
                'default' => 'disabled',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This option allows you to enable or disable the response compression for the bapXdb API. It\'s enabled by default with value "enabled", and to disable it, pass value "disabled".',
                'introduction' => '1.6.0',
                'default' => 'enabled',
                'required' => false,
                'question' => '',
    ...
    [
        'category' => 'Redis',
        'description' => 'bapXdb uses a Redis server for managing cache, queues and scheduled tasks. The Redis env vars are used to allow bapXdb server to connect to the Redis container.',
        'variables' => [
            [
    ...
    [
        'category' => 'MariaDB',
        'description' => 'bapXdb is using a MariaDB server for managing persistent database data. The MariaDB env vars are used to allow bapXdb server to connect to the MariaDB container.',
        'variables' => [
            [
                'name' => '_APP_DB_HOST',
            ...
            [
                'name' => '_APP_DB_SCHEMA',
                'description' => 'MariaDB server database schema. Default value is: \'bapxdb\'.',
                'introduction' => '',
                'default' => 'bapxdb',
                'required' => false,
                'question' => '',
    ...
    [
        ...
        'variables' => [
            ...
            [
                ...
                'description' => 'This variable allows you to disable the internal anti-virus scans. This value is set to \'disabled\' by default, to enable the scans set the value to \'enabled\'. Before enabling, you must add the ClamAV service and depend on it on main bapXdb service.',
                'introduction' => '',
                'default' => 'disabled',
                'required' => false,
                'question' => '',
    ...
    [
        ...
        'variables' => [
            ...
            [
                ...
                'description' => 'The maximum number of seconds allowed as a timeout value when creating a new function. The default value is 900 seconds. This is the global limit, timeout for individual functions are configured in the function\'s settings or in bapxdb.config.json.',
                'introduction' => '0.7.0',
                'default' => '900',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'The secret key used by bapXdb to communicate with the function executor. Make sure to change this.',
                'introduction' => '0.13.0',
                'default' => 'your-secret-key',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'The host used by bapXdb to communicate with the function executor.',
                'introduction' => '0.13.0',
            ...
            [
                ...
                'description' => 'The host used by bapXdb to communicate with the browser service for screenshots.',
                'introduction' => '1.8.0',
                'default' => 'http://bapxdb-browser:3000/v1',
                'required' => false,
                'overwrite' => true,
                'question' => '',
                'filter' => ''
            ...
            [
                ...
                'description' => 'Deprecated since 1.7.0. The minimum time a function must be inactive before it can be shut down and cleaned up. This feature is intended to clean up unused containers. Containers may remain active for longer than the interval before being shut down, as bapXdb only cleans up unused containers every hour. If no value is provided, the default is 60 seconds.',
                'introduction' => '0.13.0',
                'default' => '60',
                'required' => false,
                'question' => '',
    ...
    [
        ...
        'variables' => [
            [
                ...
                'description' => 'The maximum number of seconds allowed as a timeout value when creating a new site. The default value is 900 seconds. This is the global limit, timeout for individual functions are configured in the sites\'s settings or in bapxdb.config.json.',
                'introduction' => '1.7.0',
                'default' => '900',
                'required' => false,
                'question' => '',
    ...
    [
        ...
        'variables' => [
            [
                ...
                'description' => 'Interval value containing the number of seconds that the bapXdb maintenance process should wait before executing system cleanups and optimizations. The default value is 86400 seconds (1 day).',
                'introduction' => '0.7.0',
                'default' => '86400',
                'required' => false,
                'question' => '',
