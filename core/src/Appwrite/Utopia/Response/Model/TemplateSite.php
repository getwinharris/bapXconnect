    ...
    public function __construct()
    {
        $this
            ...
            ->addRule('tagline', [
                ...
                'default' => '',
                'example' => 'Minimal web app integrating with bapXdb.',
            ])
            ->addRule('demoUrl', [
                'type' => self::TYPE_STRING,
                'description' => 'URL hosting a template demo.',
                'default' => '',
                'example' => 'https://nextjs-starter.bapxdb.network/',
            ])
            ->addRule('screenshotDark', [
                'type' => self::TYPE_STRING,
                'description' => 'File URL with preview screenshot in dark theme preference.',
                'default' => '',
                'example' => 'https://cloud.bapxdb.io/images/sites/templates/template-for-blog-dark.png',
            ])
            ->addRule('screenshotLight', [
                'type' => self::TYPE_STRING,
                'description' => 'File URL with preview screenshot in light theme preference.',
                'default' => '',
                'example' => 'https://cloud.bapxdb.io/images/sites/templates/template-for-blog-light.png',
            ])
            ->addRule('useCases', [
                'type' => self::TYPE_STRING,
