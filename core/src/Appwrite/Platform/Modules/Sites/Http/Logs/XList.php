...
namespace bapXdb\Platform\Modules\Sites\Http\Logs;
...
use bapXdb\Utopia\Database\Validator\Queries\Logs;
...
class XList extends Base
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('queries', [], new Logs(), 'Array of query strings generated using the Query class provided by the SDK. [Learn more about queries](https://bapxdb.io/docs/queries). Maximum of ' . APP_LIMIT_ARRAY_PARAMS_SIZE . ' queries are allowed, each ' . APP_LIMIT_ARRAY_ELEMENT_SIZE . ' characters long. You may filter on the following attributes: ' . implode(', ', Executions::ALLOWED_ATTRIBUTES), true)
