    ...
    public function parse(): array
    {
        ...
        */
        ...
        if (isset($output['securityDefinitions']['Project'])) {
            $output['securityDefinitions']['Project']['x-bapxdb'] = ['demo' => '<YOUR_PROJECT_ID>'];
        }

        if (isset($output['securityDefinitions']['Key'])) {
            $output['securityDefinitions']['Key']['x-bapxdb'] = ['demo' => '<YOUR_API_KEY>'];
        }
        ...
        if (isset($output['securityDefinitions']['Locale'])) {
            $output['securityDefinitions']['Locale']['x-bapxdb'] = ['demo' => 'en'];
        }

        if (isset($output['securityDefinitions']['Mode'])) {
            $output['securityDefinitions']['Mode']['x-bapxdb'] = ['demo' => ''];
        }
            ...
            foreach ($parameters as $name => $param) { // Set params
                ...
                switch ($class) {
                    ...
                    case 'Utopia\Storage\Validator\File':
                        ...
                        $node['type'] = 'file';
                        break;
                    case 'bapXdb\Functions\Validator\Payload':
                        $consumes = ['multipart/form-data'];
                        $node['type'] = 'payload';
                        break;
                    case 'bapXdb\Utopia\Database\Validator\Queries\Base':
