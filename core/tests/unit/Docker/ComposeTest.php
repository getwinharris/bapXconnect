...
class ComposeTest extends TestCase
{
    ...
    public function testServices(): void
    {
        ...
        $this->assertEquals('bapxdb', $this->object->getService('bapxdb')->getContainerName());
        $this->assertEquals('', $this->object->getService('bapxdb')->getImageVersion());
    ...
    public function testVolumes(): void
    {
        ...
        $this->assertEquals('bapxdb-mariadb', $this->object->getVolumes()[0]);
        $this->assertEquals('bapxdb-redis', $this->object->getVolumes()[1]);
        $this->assertEquals('bapxdb-cache', $this->object->getVolumes()[2]);
    }
}
