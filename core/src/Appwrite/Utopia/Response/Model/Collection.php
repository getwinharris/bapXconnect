...
class Collection extends Model
{
    public function __construct()
    {
        $this
            ...
            ->addRule('$permissions', [
                'type' => self::TYPE_STRING,
                'description' => 'Collection permissions. [Learn more about permissions](https://bapxdb.io/docs/permissions).',
                'default' => '',
                'example' => ['read("any")'],
                'array' => true
            ])
            ...
            ->addRule('documentSecurity', [
                'type' => self::TYPE_BOOLEAN,
                'description' => 'Whether document-level permissions are enabled. [Learn more about permissions](https://bapxdb.io/docs/permissions).',
                'default' => '',
                'example' => true,
            ])
            ->addRule('attributes', [
